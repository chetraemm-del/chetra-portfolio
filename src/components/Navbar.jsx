...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <nav className="flex sm:justify-between items-center gap-13 sm:gap-3">
          <div
            ref={logoRef}
      ...
      <nav
        className={`absolute md:hidden lg:hidden bg-black mt-2 py-5 w-30 rounded-2xl transition-all duration-700 ${menuOpen ? "right-0" : "-right-200"}`}
      >
