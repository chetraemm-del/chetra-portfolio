      ...
      <div className="flex flex-wrap md:mt-20 lg:mt-20 mt-35 items-center justify-between ml-15 sm:ml-30">
        <div className="flex flex-col">
          <h1 ref={fullNameRef} className="mb-4 leading-13">
            ...
            <span
              ref={nameRef}
              className="font-bold bungee-tint-regular text-3xl sm:text-4xl lg:text-6xl md:text-6xl"
            ></span>
          </h1>
          <h1 ref={fullMajorRef} className="momo-trust-display-regular text-[16px] sm:text-xl md:text-2xl lg:text-2xl mb-4 text-gray-700">
        ...
        <div
          ref={imageRef}
          className="relative isolate md:w-70 md:h-80 lg:w-80 lg:h-100 w-80 h-80 me-35 mt-20 border-4 border-gray-700 rounded-2xl"
        >
          <img
